...
AmqpRpc.prototype.makeRequest = function(queue_name, content, callback){
    ...
    var tId = setTimeout(function(corr_id){
        ...
        //timely fashion
        callback(exception('ECONNRESET', corr_id), content);
    ...
    self.setupResponseQueue(content, function(){
...
AmqpRpc.prototype.setupResponseQueue = function(content, next){
    ...
    self.connection.queue('', {exclusive:true}, function(q){
        ...
        q.subscribe(function(message, headers, deliveryInfo, m){
            ...
            if(correlationId in self.requests){
                ...
                //callback, no err
                entry.callback(null, message, content);
            }
        });
        return next();
    });
...
exports.sendTo = function(rpc, serviceType, message, response) {
